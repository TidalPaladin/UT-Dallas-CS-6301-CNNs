...
\begin{figure}[H]
	\begin{tikzpicture}
		...
		%\networkLayer{3.0}{0.1}{0}{0.0}{color=gray!80}{
			%$3 \times 32 \times 32$
		%}


		% ENCODER
		%\repeatLayer{3}{0.1}{0.5}{0.0}{color=white}{Inc-A}{5}{0.15}    % S1

		%\networkLayer{3}{0.1}{2.2}{0.0}{color=red}{Red-A}    % S1

		%\repeatLayer{2}{0.4}{2}{0.0}{color=white}{Inc-B}{10}{0.2}    % S1

		%\networkLayer{2}{0.4}{9}{0.0}{color=red}{Red-B}    % S1

		%\repeatLayer{1}{1}{9}{0.0}{color=white}{Inc-C}{5}{0.3}    % S1

		%\featureVector{2}{0.3}{18}{0.0}{color=red!40}{Avg Pool}    % S1

		%\pic[conv2d res=2, conv2d depth=0.5, conv2d repeat=3] (A) at (10,0) {conv2d};
		\def\groupsep{0.4cm}
		...
		% OUTPUT
		%\networkLayer{2}{0.05}{17}{0.0}{color=red!40}{}
